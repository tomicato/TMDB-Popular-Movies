...
@section('content')
                  ...
                  @if (count($movie['videos']['results']) > 0)
                        <div class="mt-12">
                            ...
                            >
                                ...
                                <span class="ml-2">
                                    <a class="px-8 py-6" href="https://www.youtube.com/embed/{{ $movie['videos']['results'][0]['key'] }}" target="_blank">
                                         Play Trailer
                                    </a>
    ...
    <div class="container mx-auto px-4 py-16">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            @foreach ($movie['images']['backdrops'] as $image)
                @if($image['file_path'] && $loop->index < 9)
                    <div class="mt-8">
                        <a
                            @click.prevent="
                                 isOpen = true
    ...
    {{-- <div class="movie-images" x-data="{ isOpen: false, image: ''}">
         <div class="container mx-auto px-4 py-16">
             <h2 class="text-4xl font-semibold">Images</h2>
             <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                 @foreach ($movie['credits']['images'] as $image)
                     <div class="mt-8">
                         <a
                             @click.prevent="
                                 isOpen = true
